...
public:
	...
	//cumulatative_conflict_set (CCS): conflict set propagated from a conflict
	//current_CCS = next_CS + next_CCS - current_key
	std::unordered_map<unsigned short, unsigned short> cumulative_conflict_set;
...
public:
	...
	bool cumulative_conflict_set_find(unsigned short row, unsigned short col,
									unsigned short other_row, unsigned short other_col);

	void cumulative_conflict_set_propagate(unsigned short row, unsigned short col,
								 unsigned short other_row, unsigned short other_col);

	void conflict_set_propagate(unsigned short row, unsigned short col,
							 unsigned short other_row, unsigned short other_col);
	
	void cumulative_conflict_set_erase_self(unsigned short row, unsigned short col);
